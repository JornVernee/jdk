...
public class InterfaceWrapperClassFactory {
    ...
    /**
     * Generates a class that extends the given functional interface, implementing the given
    ...
    public static byte[] generateClassFor(Class<?> functionalInterface, String samName, MethodType samType) {
        ...
        addConstructor(cw);
        addImplMethod(cw, samName, samType);
    ...
    private static void addImplMethod(ClassWriter cw, String samName, MethodType methodType) {
