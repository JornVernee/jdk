...
public class _hb_var_int_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        hb_jdk_p_h.C_INT.withName("u32"),
        hb_jdk_p_h.C_INT.withName("i32"),
        MemoryLayout.sequenceLayout(2, hb_jdk_p_h.C_SHORT).withName("u16"),
        MemoryLayout.sequenceLayout(2, hb_jdk_p_h.C_SHORT).withName("i16"),
        MemoryLayout.sequenceLayout(4, hb_jdk_p_h.C_CHAR).withName("u8"),
        MemoryLayout.sequenceLayout(4, hb_jdk_p_h.C_CHAR).withName("i8")
